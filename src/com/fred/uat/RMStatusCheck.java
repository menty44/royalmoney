...
public class RMStatusCheck {
	...
	private static SOAPMessage createSoapRequest() throws Exception{
		 ...
		 SOAPElement soapElement1 = soapBody.addChildElement("RMStatusCheck");
         //SOAPElement soapElement1 = soapBody.addBodyElement(Name);
		 SOAPElement soapElement = soapElement1.addChildElement("ScReQ");
		 ...
		 SOAPElement element7 = soapElement.addChildElement("MTRefNo");
