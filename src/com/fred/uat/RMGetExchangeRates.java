...
public class RMGetExchangeRates {
	...
	private static SOAPMessage createSoapRequest() throws Exception{
		 ...
		 SOAPElement soapElement = soapElement1.addChildElement("GetExchReQ");
	 ...
	 private static void createSoapResponse(SOAPMessage soapResponse) throws Exception  {
		...
		// Get reply content		
		String resp1  = soapResponse.getSOAPPart().getElementsByTagName("ExchangeRate").item(0).getFirstChild().getNodeValue();
